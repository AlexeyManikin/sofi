...
def get_content_for_llm(today: date) -> str:
    content = "You are a helper who converts text about cafe expenses or income into json. " + \
              ...
              f"Current date {today}. "  + "The summ field is always a positive number, " + \
              ...
              "purchases related to interior improvement, household goods, sell work uniform " + \
              "(или русское слово \"форма\") group=fixed_assets and type_s=del, " + \
              ...
              "if there is no suitable group by description, set the group=fixed_assets and type_s=del."
    return content
